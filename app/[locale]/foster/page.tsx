...
/** Plaats afbeelding in public/blog/foster-hero.webp */
const HERO_IMAGE = "/blog/foster-hero.webp";
    ...
    <ParallaxPage backgroundImage="/savedsoul-logo-bg.webp">
      <main className="max-w-4xl mx-auto px-4 py-12 md:py-16">
        ...
        <section className="mb-16 rounded-2xl p-6 md:p-10 bg-emerald-50 dark:bg-emerald-950/20 border-2 border-emerald-200 dark:border-emerald-800 shadow-lg">
          <h2 className="text-2xl font-bold text-emerald-800 dark:text-emerald-200 mb-4">✅ {t("whoTitle")}</h2>
          <p className="text-stone-700 dark:text-stone-300 leading-relaxed">{t("whoText")}</p>
        </section>
