...
export default function HeartwormPage() {
  const t = useTranslations("heartworm");
    ...
    <ParallaxPage backgroundImage="/savedsoul-logo-bg.webp">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 md:py-16">
        ...
        <section className="mb-16 rounded-2xl p-6 md:p-10 bg-white dark:bg-stone-900 border-2 border-stone-200 dark:border-stone-700 shadow-lg">
          ...
          <h3 className="text-lg font-semibold text-stone-800 dark:text-stone-100 mb-3">{t("problemsWhatTitle")}</h3>
          <p className="text-stone-600 dark:text-stone-400 mb-4 leading-relaxed">{t("problemsWhat")}</p>
          <h3 className="text-lg font-semibold text-stone-800 dark:text-stone-100 mb-3">{t("problemsCycleTitle")}</h3>
          <p className="text-stone-600 dark:text-stone-400 mb-4 leading-relaxed">{t("problemsCycle")}</p>
          <h3 className="text-lg font-semibold text-stone-800 dark:text-stone-100 mb-3">{t("problemsDogTitle")}</h3>
          <p className="text-stone-600 dark:text-stone-400 mb-4 leading-relaxed">{t("problemsDog")}</p>
          <h3 className="text-lg font-semibold text-stone-800 dark:text-stone-100 mb-3">{t("problemsCatTitle")}</h3>
          <p className="text-stone-600 dark:text-stone-400 leading-relaxed">{t("problemsCat")}</p>
        </section>
        ...
        <section className="mb-16 rounded-2xl p-6 md:p-10 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30 border-2 border-stone-200 dark:border-stone-700 shadow-lg">
          ...
          <h3 className="text-lg font-semibold text-stone-800 dark:text-stone-100 mb-3">{t("treatmentDogTitle")}</h3>
          <p className="text-stone-600 dark:text-stone-400 mb-4 leading-relaxed">{t("treatmentDog")}</p>
          <h3 className="text-lg font-semibold text-stone-800 dark:text-stone-100 mb-3">{t("treatmentCatTitle")}</h3>
          <p className="text-stone-600 dark:text-stone-400 leading-relaxed">{t("treatmentCat")}</p>
        </section>
        ...
        <section className="mb-16 rounded-2xl p-6 md:p-10 bg-white dark:bg-stone-900 border-2 border-stone-200 dark:border-stone-700 shadow-lg">
          ...
          <h3 className="text-lg font-semibold text-stone-800 dark:text-stone-100 mb-3">{t("preventionMonthlyTitle")}</h3>
          <p className="text-stone-600 dark:text-stone-400 mb-4 leading-relaxed">{t("preventionMonthly")}</p>
          <ul className="space-y-2 text-stone-600 dark:text-stone-400 mb-6">
            <li>• <strong>Ivermectine</strong> – {t("preventionIvermectin")}</li>
            <li>• <strong>Moxidectine</strong> – {t("preventionMoxidectin")}</li>
            <li>• <strong>Selamectine</strong> – {t("preventionSelamectin")}</li>
            <li>• <strong>Milbemycine</strong> – {t("preventionMilbemycin")}</li>
          </ul>
          <h3 className="text-lg font-semibold text-stone-800 dark:text-stone-100 mb-3">{t("preventionProductsTitle")}</h3>
          <p className="text-stone-600 dark:text-stone-400 mb-4 leading-relaxed">{t("preventionProducts")}</p>
          <h3 className="text-lg font-semibold text-stone-800 dark:text-stone-100 mb-3">{t("preventionWhenTitle")}</h3>
          <p className="text-stone-600 dark:text-stone-400 mb-4 leading-relaxed">{t("preventionWhen")}</p>
          <h3 className="text-lg font-semibold text-stone-800 dark:text-stone-100 mb-3">{t("preventionTravelTitle")}</h3>
          <p className="text-stone-600 dark:text-stone-400 leading-relaxed">{t("preventionTravel")}</p>
        </section>
