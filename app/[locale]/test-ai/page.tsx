    ...
    <div className="min-h-screen bg-stone-100 p-6">
      ...
      <div className="space-y-8 max-w-2xl">
        ...
        <section className="bg-white rounded-xl border border-stone-200 p-5 shadow-sm">
          <h2 className="text-lg font-semibold text-stone-800 mb-3">Test AI Usage</h2>
          <button
            type="button"
            onClick={testUsage}
        ...
        {/* 2. Email Processor */}
        <section className="bg-white rounded-xl border border-stone-200 p-5 shadow-sm">
          <h2 className="text-lg font-semibold text-stone-800 mb-3">Test Email Processor</h2>
        ...
        {/* 3. Blog Generator */}
        <section className="bg-white rounded-xl border border-stone-200 p-5 shadow-sm">
          <h2 className="text-lg font-semibold text-stone-800 mb-3">Test Blog Generator</h2>
          <button
            type="button"
        ...
        {/* 4. Agenda Reminder */}
        <section className="bg-white rounded-xl border border-stone-200 p-5 shadow-sm">
          <h2 className="text-lg font-semibold text-stone-800 mb-3">Test Agenda Reminder</h2>
          <button
            type="button"
        ...
        {/* 5. Social Generator */}
        <section className="bg-white rounded-xl border border-stone-200 p-5 shadow-sm">
          <h2 className="text-lg font-semibold text-stone-800 mb-3">Test Social Generator</h2>
          <div className="flex gap-2 items-center mb-3">
            <input
              type="text"
              value={blogPostId}
        ...
        <section className="bg-white rounded-xl border border-stone-200 p-5 shadow-sm">
          <h2 className="text-lg font-semibold text-stone-800 mb-3">Test Spotlight (30min test)</h2>
