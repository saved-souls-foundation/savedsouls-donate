...
export default function SkinProblemsPage() {
  const t = useTranslations("skinProblems");
  ...
  return (
    <ParallaxPage backgroundImage="/savedsoul-logo.webp">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 md:py-16">
        ...
        <section className="mb-16 rounded-2xl p-6 md:p-10 bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/30 border-2 border-stone-200 dark:border-stone-700 shadow-lg">
        ...
        <section className="mb-16 rounded-2xl p-6 md:p-10 bg-white dark:bg-stone-900 border-2 border-stone-200 dark:border-stone-700 shadow-lg">
          ...
          <h3 className="text-lg font-semibold text-stone-800 dark:text-stone-100 mb-3">{t("hotspotsTitle")}</h3>
          <p className="text-stone-600 dark:text-stone-400 leading-relaxed">{t("hotspots")}</p>
        </section>
        ...
        <section className="mb-16 rounded-2xl p-6 md:p-10 bg-gradient-to-br from-rose-50 to-pink-50 dark:from-rose-950/30 dark:to-pink-950/30 border-2 border-stone-200 dark:border-stone-700 shadow-lg">
          ...
          <ul className="space-y-2 text-stone-600 dark:text-stone-400 mb-4">
            ...
            <li>• <strong>{t("cause4")}</strong> – {t("cause4Text")}</li>
          </ul>
          <h3 className="text-lg font-semibold text-stone-800 dark:text-stone-100 mb-3">{t("foodAllergyTitle")}</h3>
          <p className="text-stone-600 dark:text-stone-400 leading-relaxed">{t("foodAllergy")}</p>
        </section>
