    ...
    <ParallaxPage backgroundImage="/savedsoul-logo-bg.webp">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 md:py-16">
        ...
        <section className="mb-16 rounded-2xl p-8 md:p-12 text-center bg-gradient-to-br from-stone-50 to-stone-100 dark:from-stone-800 dark:to-stone-900 border-2 border-stone-200 dark:border-stone-600">
          ...
          <Link href="/#donate" className="inline-flex items-center justify-center px-8 py-4 rounded-xl font-bold text-white transition-all hover:scale-105 hover:shadow-lg" style={{ backgroundColor: BUTTON_ORANGE }}>
            {t("ctaButton")}
          </Link>
        </section>
