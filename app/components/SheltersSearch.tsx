  ...
  return (
    ...
    >
      ...
      <div className="p-5 bg-white dark:bg-stone-900">
        ...
        <p className="text-base text-stone-500 dark:text-stone-400 mb-3">{s.location}</p>
        <p className="text-sm text-stone-600 dark:text-stone-300 truncate" title={s.email}>
          ✉️ {s.email}
        </p>
