...
function SocialIcon({ icon, className }: { icon: string; className?: string }) {
  ...
  const icons: Record<string, React.ReactNode> = {
    facebook: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className} width={size} height={size} suppressHydrationWarning>
...
export default function FooterContent() {
  ...
  const isTrustImpact = mounted && pathname.includes("/trust-impact");
  const base = `/${locale}`;
      ...
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-sm text-white/70 max-w-xs mx-auto text-center mt-1 mb-4">
            <span suppressHydrationWarning>{t("footerShortDesc")}</span>
          </p>
        ...
        >
          <div>
            <p className="text-xs font-semibold tracking-widest uppercase text-white/50 mb-4">
              <span suppressHydrationWarning>{t("footerColOrganisation")}</span>
            </p>
            <ul className="space-y-3">
              ...
              <li key="blog">
                <a href={`${base}/blog`} className="text-sm text-white/70 hover:text-white transition-colors" suppressHydrationWarning>
                  <span suppressHydrationWarning>{t("blog")}</span>
                </a>
              </li>
          ...
          <div>
            <p className="text-xs font-semibold tracking-widest uppercase text-white/50 mb-4">
              <span suppressHydrationWarning>{t("footerColGetInvolved")}</span>
            </p>
            <ul className="space-y-3">
              <li key="get-involved"><a href={`${base}/get-involved`} className="text-sm text-white/70 hover:text-white transition-colors"><span suppressHydrationWarning>{t("getInvolved")}</span></a></li>
              <li key="dashboard"><a href={`${base}/dashboard`} className="text-sm text-white/70 hover:text-white transition-colors"><span suppressHydrationWarning>{t("myProgress")}</span></a></li>
              ...
              <li key="partners">
                <a
                  href={`${base}/partners`}
                  className="golden-shimmer inline-block rounded px-1 -mx-1 text-sm text-white/70 hover:text-white transition-colors"
                >
                  <span suppressHydrationWarning>{t("partners")}</span>
                </a>
              </li>
          ...
          <div>
            <p className="text-xs font-semibold tracking-widest uppercase text-white/50 mb-4">
              <span suppressHydrationWarning>{t("footerColInfo")}</span>
            </p>
            <ul className="space-y-3">
          ...
          <div>
            <p className="text-xs font-semibold tracking-widest uppercase text-white/50 mb-4">
              <span suppressHydrationWarning>{t("footerColActions")}</span>
            </p>
            <ul className="space-y-3">
              <li key="car-action"><a href={`${base}/car-action`} className="text-sm font-medium text-white/90 hover:text-white transition-colors"><span suppressHydrationWarning>{t("carAction")}</span></a></li>
              <li key="clinic-renovation"><a href={`${base}/clinic-renovation`} className="text-sm font-medium text-white/90 hover:text-white transition-colors"><span suppressHydrationWarning>{t("footerClinicAction")}</span></a></li>
            </ul>
          </div>
        </nav>
        ...
        <p className="text-center text-white/40 text-xs">
          <span suppressHydrationWarning>© {new Date().getFullYear()} Saved Souls Foundation</span>
        </p>
